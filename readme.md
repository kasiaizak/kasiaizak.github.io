...
- strona **Pauliny Peckiel** - dodanie dodatkowych właściwości CSS i skryptu jQuery dostosowujących *chmurę tagów dla wpisów* oraz *chmurę tagów dla zdjęć z wtyczki NextGen Gallery* do oczekiwań właścicielki strony
- strona **FAME Fitness** - dodanie dodatkowych właściwości CSS dostosowujących motyw *Storefront* do oczekiwań właściciela strony
